...
const getMyUscCookiesDuo2 = async (bundledData) => {
    ...
    console.log(`FrameStatusPost2Response.data`)
    console.log(FrameStatusPost2Response.data)
    ...
    console.log(`FrameStatusPost3Response.data`)
    console.log(FrameStatusPost3Response.data)
    ...
    // const AuthorizationResponse = await tryCatchWrapper(() => axios({
    //     method: 'get',
    //     url: 'https://api.usc.edu/auth/trojancheck/Authorization', //'https://my.usc.edu/portal/Shibboleth.sso/SAML2/POST',
    //     headers: genHeaders(allCookies),
    //     maxRedirects: 0,
    //     validateStatus:  () => true //VS,
    // }), "AuthRes");
