...
const parseBlackboardAnnouncements = (announcements) => {
    ...
    let announcementBlock = getValueByDelimiters(announcements, '<form name="announcementForm" id="announcementForm"', '</form>')

    let parsingAnnouncementBlock = announcementBlock;
