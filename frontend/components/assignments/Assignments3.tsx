    ...
    return (
        <div className="h-full w-1/5 p-10">
            <div className="w-full h-full flex flex-col justify-start items-center drop-shadow-md">
                ...
                {/* Content */}
                <div className="w-full h-auto rounded-b-xl bg-zinc-100 px-4 py-2 flex flex-col justify-start items-center space-y-8">
                    ...
                    <div className="w-full flex flex-col justify-start items-center">
                        ...
                        <div className="text-slate-800 w-full font-bold px-2 flex justify-start items-center">
                            ...
                            <span className="ml-1 font-medium text-md text-slate-400">• 12/25/21</span>
                        </div>
                    ...
                    <div className="w-full flex flex-col justify-start items-center">
                        ...
                        <div className="text-slate-800 w-full font-bold px-2 flex justify-start items-center">
                            ...
                            <span className="ml-1 font-medium text-md text-slate-400">• 12/26/21</span>
                        </div>
                        <div className="w-full h-auto py-2 flex flex-col justify-start items-center drop-shadow-md relative">
                            ...
                            {/* Content */}
                            <div className="w-full h-full rounded-b-md bg-indigo-300 px-2 py-2 text-zinc-50 text-2xl text-center">
                                Homework 9
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full flex flex-col justify-start items-center">
                        ...
                        <div className="text-slate-800 w-full font-bold px-2 flex justify-start items-center">
                            ...
                            <span className="ml-1 font-medium text-md text-slate-400">• 12/27/21</span>
                        </div>
                        <div className="w-full h-auto py-2 flex flex-col justify-start items-center drop-shadow-md relative">
                            ...
                            {/* Top Header */}
                            <div className="h-auto w-full rounded-t-md bg-emerald-400 flex justify-center items-center py-2">
                                <div className="font-bold text-3xl text-zinc-50">
                                    WRIT-340
                                </div>
                            </div>
                            ...
                            {/* Content */}
                            <div className="w-full h-full rounded-b-md bg-emerald-300 px-2 py-2 text-zinc-50 text-2xl text-center">
                                Essay 2
                            </div>
                        </div>
                    </div>
